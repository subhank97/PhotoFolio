        ...
        <div className="sm:flex sm:items-start">
          ...
          <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left sm:w-1/2 pt-3 flex flex-col justify-between">
            <div>
              ...
              <h3 className="pb-5 text-base font-semibold leading-6" id="modal-title">{member}</h3>
              <div className="mt-2">
            ...
            <div className="flex flex-col justify-between flex-grow mt-20 overflow-wrap: break-word">
