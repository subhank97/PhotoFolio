...
function Profile({ comments, user, posts, setPosts }) {
              ...
              <div class="flex flex-wrap justify-center">
                <div class="w-full lg:r-0 px-4 lg:order-3 lg:text-right lg:self-center">
                  <div class="py-6 px-3 mt-32 sm:mt-0">
                    <button class="bg-amber-400 active:bg-amber-600 uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1 ease-linear transition-all duration-150" type="button">
                      Logout
                    </button>
                  </div>
                </div>
